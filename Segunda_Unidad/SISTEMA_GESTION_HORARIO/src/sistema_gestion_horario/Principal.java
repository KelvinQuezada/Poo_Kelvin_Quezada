...
public class Principal {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numLaboratorios; i++) {
            ...
            //llamamos el nombre de la clase Principal Laboratorio y el objeto laboratorio
            ...
            if (tipo == 1) {
                ...
                //llamamos al objeto laboratorio y llamamos al la clase hija Laboratorio1 con sus atributos de la clase principal Laboratorio 
        ...
        for (int i = 0; i < numAsignaturas; i++) {
            ...
            //for (inicializamos, condicion, el size nos devuelve un entero con el tamaño de la lista, aumento o decremento)
            ...
            //llamaremos a la clase principal laboratorio y creamos el objeto y llamaos el metodo 
            Laboratorio laboratorio = laboratorios.get(labIndex);
            //llamaremos a la clase principal Asignatura y creamos el objeto y llamaos los atributos de la clase asignatura 
